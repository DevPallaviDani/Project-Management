...
const assignedTasks = tasks.filter(
    (t) => t.assigneeId === loggedInUser.userId,
  );
  ...
  return (
    ...
    >
      ...
      icon={
            <MdTask size={40} className="hover:scale-105 " color={"gray"}/>
          }
      />
      <StatsCard title="Completed Tasks" value={completedTasks} 
      icon={<SiGoogletasks size={40} color={"green"}/>}/>
      <StatsCard title="Assigned Tasks" value={totalAssignedTasks} 
       icon={<GoTasklist size={40} color={"blue"}/>}/>
        <StatsCard title="overDue Tasks" value={totalTasks} 
